...
window.onload = function () {
    ...
    try {
        ...
        function StartGame() {
            ...
            var UpTimer, LeftTimer, DownTimer, RightTimer, MoveTimer, RunTimer, MessageInTimer, MessageOutTimer,
                WaitOut, WaitNextMessageTimer, ShowWordTimer, EnemyBookAnimate, FloorTipTimer, MessageIconAnimate,
                ChooseFloorTimer, BattleAnimateTimer;
            var AnimateNoPass = 0;
            var ResPath = "./img/"; //资源路径
            //资源名称列表
            ...
            function CreateEventControl(EnemyData, callback) {
                    ...
                    if (Flag.BattleAnimate) {
                        ...
                        if (Hero["HP"] > Damage) {
                            ...
                            if (TestNull(EnemyData[5]) && EnemyData[5] != -1) {
                                ...
                                e.RunEvent(EnemyData[5], function () {
                ...
                e.ChangeHead = function () {
                    ...
                    switch (HeroLocation[0]) {
                        case 0:
                            Head = HeroLocation[0] = 3;
                            break;
                        case 1:
                            Head = HeroLocation[0] = 0;
                            break;
                        case 2:
                            Head = HeroLocation[0] = 1;
                            break;
                        case 3:
                            Head = HeroLocation[0] = 2;
                            break;
                    }
                ...
                e.SaveGame = function (Choose, callback) {
                    ...
                    if (window.localStorage) {
                        ...
                        var SaveData = {
                            ...
                            "Gold": Hero["Gold"],
                            "Exp": Hero["Exp"],
                            "PayGold": Hero["PayGold"],
                            "YellowKey": Hero["YellowKey"],
                            "BlueKey": Hero["BlueKey"],
                            "RedKey": Hero["RedKey"],
                            "IronKey": Hero["IronKey"],
                            "HeroLocation": HeroLocation,
                            "MapsData": Map.Maps,
                            "Flag": Flag,
                            "ToolPanelChoose": ToolPanelChoose,
                            "ToolsData": ToolsData,
                            "Zoom": Zoom,
                            "Version": Version,
                            "Date": DateStr
            ...
            function CreateMapControl(MapBg, MapEvent, MapFg, SystemUI, DataUpdate, ResData, MapsData, IconsData, ItemsData) {
                ...
                m.DrawThumbnail = function (Canvas, MotaData, X, Y, Size, SetFloor, callback) {
                    ...
                    for (var i = 0; i < ItemEventData.length; i++) {
                        IconData = m.Icons.GetData("Item", ItemEventData[i][1]);
                        Canvas.drawImage(m.Res[IconData[5]], IconData[1], IconData[2], IconData[3], IconData[4], X + ItemEventData[i][2] * Size, Y + ItemEventData[i][3] * Size, Size, Size);
                    }
                    //楼梯
                ...
                m.DrawEvent = function (Floor, callback) {
                    ...
                    for (var i = 0; i < ItemEventData.length; i++) {
                        IconData = m.Icons.GetData("Item", ItemEventData[i][1]);
                        m.Event.drawImage(m.Res[IconData[5]], IconData[1], IconData[2], IconData[3], IconData[4], ItemEventData[i][2] * IconData[3], ItemEventData[i][3] * IconData[4], IconData[3], IconData[4]);
            ...
            LoadResource(ResPath, ResNameList, function () {
                CreateEventControl(EnemyData, function (e) {
                    Event = e
                });
